...
A〜Hの検索は食材軸のため和食候補に偏りやすい。Step 3 で洋・中・エスニック枠を確実に埋めるため、以下をあわせて実施する。

**I. 洋風（今週の肉・魚＋洋風調理法）**
- 検索例：`鶏もも トマト煮込み 作り置き site:kurashiru.com`
- 検索例：`豚こま クリーム 作り置き site:kurashiru.com`
- 検索例：`鶏むね ハーブ オーブン 作り置き site:kurashiru.com`

**J. 中華（今週の肉・魚＋中華調味料）**
- 検索例：`鶏もも オイスター 中華 作り置き site:kurashiru.com`
- 検索例：`豚こま ごま油 中華炒め 作り置き site:kurashiru.com`
- 検索例：`鶏肉 甜面醤 中華 作り置き site:kurashiru.com`

**K. エスニック（今週の肉・魚＋エスニック調味料）**
- 検索例：`鶏もも ナンプラー エスニック 作り置き site:kurashiru.com`
- 検索例：`豚こま コチュジャン 作り置き site:kurashiru.com`
- 検索例：`鶏むね カレー粉 作り置き site:kurashiru.com`

---

### 検索の最低条件
- A〜Kを合わせて**合計50件以上**の候補名を収集してから次に進む
- 50件未満の場合は食材・調理法のキーワードを変えて追加検索する
- 洋・中・エスニックそれぞれ**最低5件以上**確保できていること。不足するジャンルは I〜K の該当軸で追加検索する
