...
- **献立は「全部作る計画」ではなく「食べたいものを選ぶためのカタログ」である（重要）。** ユーザーは提示された中から作るものを選ぶため、**品数は必ず規定数（主菜16・副菜4）を揃える**。配達食材は発想の起点にすぎず、**食材の量的な整合・使い切りは一切考慮しなくてよい**。配達に無い食材（じゃがいも・ひき肉・もやし・豆腐等）も買い足し前提で自由に使う。**「食材が足りないから品数を減らす」判断は禁止**
...
## お願い
上記の食材を発想の起点にしつつ、以下の形式でJSONのみ返してください。
**この献立は「選ぶためのカタログ」です。全品を作る前提ではないので、食材の量的な整合は考えず、配達に無い食材も買い足し前提で自由に使い、必ず規定の品数を揃えてください。**
